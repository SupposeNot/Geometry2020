...
\begin{definition} A \emph{pencil of lines} is a collection of lines that either all go through the same given point or all are parallel to the same given line.
\end{definition} 
